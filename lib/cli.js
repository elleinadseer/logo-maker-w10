...
// Directs the SVG file to the examples folder
function initialize() {
...
// Prompts and creates SVG file from the responses (includes error handling)
class CLI {
  constructor() {
  }
...
// Generates SVG by using a Switch Case to push code based on prompt choices
generateSVG(options) {
...
// Runs initalise function that sends SVG file to examples folder
initialize();

// Exports CLI for index.js
module.exports = CLI;
